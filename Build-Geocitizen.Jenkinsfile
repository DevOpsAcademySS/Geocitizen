        ...
        success{
            ...
            script {
                if (params.Ansible == true)
                    build job: 'GitHub-Ansible-Configuration', parameters: [string(name: 'WEB_IP', value: String.valueOf(params.WEB_IP)), string(name: 'DB_IP', value: String.valueOf(params.DB_IP))]
            }
        }
        failure{
            echo "FAIL:("
